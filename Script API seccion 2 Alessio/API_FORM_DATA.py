...
response = session.post(url + "/usuario", data=data_seba)
...
response = session.post(url + "/usuario", data=data_juan)
print_result(response, "/usuario")
...
response = session.post(url + "/ingresar", data=data)
...
response = session.post(url + "/recargar", data=data)
...
response = session.post(url + "/retirar", data=data)
...
response = session.post(url + "/transferir", data=data)
